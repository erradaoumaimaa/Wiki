...
<body class="overflow-x-hidden bg-gray-100">
    <?php
    require_once APPROOT . "/views/include/admin_nav.php";
    ?>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center"> <!-- Use flex container for category and button -->
                                            <a href="#"
                                            ...
                                            <!-- Archive button -->
                                            <a href="<?php echo URLROOT; ?>/wikis/archive/<?php echo $wiki->id; ?>">
                                                <button class="ml-2">
                                                    <svg class="text-purple-600 w-6 h-6" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div>
                                            <a href="#" class="flex items-center">
                                                ...
                                                <div class="relative flex-shrink-0">
                                                    ...
                                                    <div
                                                        class="w-10 h-10 mx-4 rounded-full bg-purple-400/50 flex items-center justify-center">
