    ...
    <nav class="px-6 py-4 bg-white shadow">
        <div class="container flex flex-col mx-auto md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex-col hidden md:flex md:flex-row md:-mx-4">
                ...
                <a href="<?php echo URLROOT; ?>/wikis/addWiki" class="my-1 text-gray-800 hover:text-blue-500 md:mx-4 md:my-0"><i class="fa-solid fa-plus"></i> Add Wiki</a>
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <?php if ($_SESSION['user_id'] == $wiki->user_id) : ?>
                    <div class="mt-4 flex items-center space-x-4"> 
                        <a href="<?php echo URLROOT; ?>/wikis/updateForm/<?php echo $wiki->id; ?>" class="text-blue-500 hover:underline">
                            <button> 
                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="24"  height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                            </button>
                        </a>
                        <a href="<?php echo URLROOT; ?>/wikis/deleteOne/<?php echo $wiki->id; ?>" class="text-red-500 hover:underline">
                            <button>
