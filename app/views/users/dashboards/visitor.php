...
<body class="overflow-x-hidden bg-gray-100">
    <?php
    require_once APPROOT . "/views/include/visitor_nav.php";
    ?>
            ...
            <div class="mx-auto flex flex-col items-center py-12 sm:py-24">
                <div class="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
                    ...
                    <p class="mt-5 sm:mt-10 lg:w-10/12 text-gray-600 dark:text-gray-300 font-normal text-center text-xl">
                        In the tapestry of articles, words become art, and sentences paint stories. Let your ideas flow
                        and create a masterpiece that captivates minds and sparks inspiration
                    </p>
                </div>
