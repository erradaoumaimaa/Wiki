...
<div class="relative p-40">
    ...
    <a href="<?= URLROOT . '../users/dashboard' ?>" class="back text-gray-600 hover:text-gray-800 ml-4 mt-4">
        ...
        <div
            ...
            <div class="">
                <h1 href="#" class="text-gray-900 font-bold text-4xl"><?php echo $data['wiki']->title ?></h1>
	...
	<g>
		<path d="M256,0C114.837,0,0,114.837,0,256s114.837,256,256,256s256-114.837,256-256S397.163,0,256,0z M277.333,256
			c0,11.797-9.536,21.333-21.333,21.333h-85.333c-11.797,0-21.333-9.536-21.333-21.333s9.536-21.333,21.333-21.333h64v-128
                       ...
                       <?php $createdAt = new DateTime($data['wiki']->created_at);
                    ...
                    <a href="#" class="flex flex-row items-center hover:text-indigo-600  mr-3">
                        ...
                        <span class="ml-1"><?php echo $data['wiki']->fname ?> <?php echo $data['wiki']->lname ?></span></a>
                    ...
                    <a href="#" class="flex flex-row items-center hover:text-indigo-600">
                        ...
                        <span class="ml-1"><?php echo $data['category']->title ?? 'Category Not Assigned'; ?></span>
                        </a>
                </div>
                <hr>
